    ...
    <>
      ...
      >
        <div className="flex items-center justify-between w-full px-6 md:px-12 lg:px-16 2xl:px-24">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#1E40AF] via-[#2F80FF] to-[#8EC5FF] p-0.5 shadow-sm group-hover:scale-105 transition-transform duration-300 flex items-center justify-center">
              <div className="w-full h-full bg-white rounded-[10px] flex items-center justify-center">
                <span className="material-symbols-outlined text-[#2F80FF] text-xl font-bold filled">
                  school
                </span>
              </div>
            </div>
        ...
        <motion.div
          className="absolute bottom-0 left-0 right-0 h-[2.5px] bg-gradient-to-r from-[#2F80FF] via-[#8EC5FF] to-[#1E40AF] origin-left"
          style={{ scaleX }}
        />
      </motion.nav>
